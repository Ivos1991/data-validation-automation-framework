...
from src.framework.utils.dataframe_utils import filter_expected_trip_frame
from src.validators.reconciliation.trip_reconciliation_validator import TripReconciliationValidator
from tests.large_dataset_tests.support import scenario_by_id
...
class TestLargeSyntheticDataset:
    ...
    def test_large_synthetic_dataset_expects_row_level_reconciliation_to_match(
        ...
        scenario = scenario_by_id(large_batch_scenarios, "large-combined-nyc-was-amrail-nonstop")
